...
# Write version.ps1 (avoid variable expansion inside content)
$body = @'
# Centralized version definition for release scripts
# Auto-generated by read_version_from_csproj.ps1 from: {0}
# Do not edit manually. Update the <Version> in the .csproj instead.
$version = "{1}"
'@ -f ([System.IO.Path]::GetFileName($ProjectPath)), $version
$body | Out-File -FilePath $OutputPath -Encoding utf8 -Force
